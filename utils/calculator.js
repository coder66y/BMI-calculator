...
class BMICalculator {
    ...
    getIdealWeightRange(height) {
        ...
        const minBMI = normalCategory.min;
        const maxBMI = normalCategory.max;
     ...
     * @returns 详细分析结果
     */
    getDetailedAnalysis(height, weight) {
        try {
            const bmi = this.calculateBMI(height, weight);
            const category = this.getBMICategory(bmi);
            const idealRange = this.getIdealWeightRange(height);
            return {
                bmi: bmi,
                category: category,
...
module.exports = {
    bmiCalculator,
    calculateBMI: (height, weight) => bmiCalculator.calculateBMI(height, weight),
    getBMICategory: (bmi) => bmiCalculator.getBMICategory(bmi),
    getHealthAdvice: (bmi) => bmiCalculator.getHealthAdvice(bmi),
    getDetailedAnalysis: (height, weight) => bmiCalculator.getDetailedAnalysis(height, weight),
    validateInput: (height, weight) => bmiCalculator.validateInput(height, weight),
    getIdealWeightRange: (height) => bmiCalculator.getIdealWeightRange(height),
    getBMIKnowledge: () => bmiCalculator.getBMIKnowledge()
};
